...
public class SmsHelper {
    private static final String SMS_PARAM_KEY_PHONE = "PhoneNumbers";
    private static final String SMS_PARAM_KEY_SIGN_NAME = "SignName";
    private static final String SMS_PARAM_KEY_TEMPLATE_CODE = "TemplateCode";
    private static final String SMS_PARAM_KEY_TEMPLATE_PARAM = "TemplateParam";

    /**
     * 响应结果
     */
    private static final String SMS_RESPONSE_KEY_CODE = "Code";
    private static final String SMS_RESPONSE_KEY_MESSAGE = "Message";
    ...
    public void sendMessage(String phone, String signName, String template, String param) {
        ...
        try {
            ...
            if (!StringUtils.equals(OK, resp.get(SMS_RESPONSE_KEY_CODE))) {
                ...
                throw new LyException(ResponseCode.SEND_MESSAGE_ERROR);
            }
